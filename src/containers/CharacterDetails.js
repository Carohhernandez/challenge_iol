...
// Queries
import { FETCH_CHARACTER } from "../queries/fetchCharacter";
...
const CharacterDetails = () => {
    ...
    const { loading, error, data } = useQuery(FETCH_CHARACTER, { variables: { id } });
    ...
    if (error || !character) { return <ErrorNote message="The character doesn't exist" withBack/> }
